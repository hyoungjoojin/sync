...
OAUTH2_CLIENT_REGISTRATION_NAVER_CLIENT_ID=$(echo "$SERVER_SECRET" | jq -r .OAUTH2_CLIENT_REGISTRATION_NAVER_CLIENT_ID)
OAUTH2_CLIENT_REGISTRATION_NAVER_CLIENT_SECRET=$(echo "$SERVER_SECRET" | jq -r .OAUTH2_CLIENT_REGISTRATION_NAVER_CLIENT_SECRET)
